              ...
              <v-card-text>
                <v-container grid-list-md text-xs-center>
                  <v-layout row wrap>
                    ...
                    <v-flex xs12>Store sales report</v-flex>
                    <v-flex xs12>
                          ...
                          <v-date-picker v-model="storeSelectedDate" no-title scrollable actions>
                            <template slot-scope="{ save, cancel }">
                              <v-card-actions>
                                ...
                                <v-btn flat color="primary" @click="fetchStoreReport">OK</v-btn>
                              </v-card-actions>
                            </template>
                          </v-date-picker>
                        </v-menu>
                    ...
                    <v-flex xs12>
                      <v-container fluid style="min-height: 0;" grid-list-lg>
                        <v-layout row wrap >
                          <v-flex xs3 v-for="store in storeList" :key="store.id" v-on:click="showReport(store)">
                    ...
                    <v-flex xs12 >
                      <v-dialog v-model="storeReportDialog" maxWidth="1200px" >
                        <v-card>
                          <v-card-title>
                            <span class="headline">STORE REPORT</span>
                          </v-card-title>
                          <v-card-text>
...
//        Sent Data
    ...
    methods: {
      refreshDB(){
        this.$store.dispatch('fetchStockReports');
      },
      currentDate(){
        let date = new Date();
...
//      STORE QUERY
      fetchStoreReport(){
        ...
        this.$store.dispatch('fetchStoreReports', this.storeDateQuery).then(() =>{
          setTimeout(() => {
